...
public class UIUtil {
    ...
    public static int dp2px(float dpValue) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpValue, TempApplication.context.getResources().getDisplayMetrics());
    }
    ...
    public static float dp2pxF(float dpValue) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpValue, TempApplication.context.getResources().getDisplayMetrics());
    }
    ...
    public static int sp2px(float spValue) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, spValue, TempApplication.context.getResources().getDisplayMetrics());
    }
    ...
    public static float px2dp(float pxVal) {
        final float scale = TempApplication.context.getResources().getDisplayMetrics().density;
        return (pxVal / scale);
    }
    ...
    public static float px2sp(float pxVal) {
        return (pxVal / TempApplication.context.getResources().getDisplayMetrics().scaledDensity);
    }
    ...
    public static int getStatusBarHeight() {
        Resources resources = TempApplication.context.getResources();
    ...
    public static int getScreenWidth() {
        WindowManager windowManager = (WindowManager) TempApplication.context.getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getDimensionPixelOffset(@DimenRes int resId) {
        return TempApplication.context.getResources().getDimensionPixelOffset(resId);
    }
